# Variational Inference-Decomposable Point Process model (VI-DPP) 

Pytorch implementation of the (vanilla) Variational Inference-Decomposable Point Process model (VI-DPP).
